...
//     { id: '1', date: '2023-10-01', time: '10:00 AM', doctor: 'Dr. Smith', status: 'upcoming' },
//     { id: '2', date: '2023-10-05', time: '02:00 PM', doctor: 'Dr. Jones', status: 'upcoming' },
//     { id: '3', date: '2023-09-28', time: '11:00 AM', doctor: 'Dr. Brown', status: 'completed' }
//   ];
//   isLoading = true;
...
export class PatientDashboardComponent implements OnInit {
  ...
  patientProfile: any = {
    ...
    photo: '' // Empty will load default photo
  };

  constructor(private router: Router) {}

  ngOnInit(): void {
    // No backend calls for now. Using hardcoded data.
  }
  ...
  edit(){
 this.router.navigate(['/edit-page-patient'], { state: { patient: this.patientProfile } });
  }
